promedio = float(input("ingrese su promedio de enseñanza media:"))
quintil = int(input("ingrese su nivel de quintil 1,2,3,4,5:"))

valor_arancel = 1800000
valor_matricula = 90000

if 1>quintil<5:
    print("porfavor ingrese datos dentro de lo estipulado")
